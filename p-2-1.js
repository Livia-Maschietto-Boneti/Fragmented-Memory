...
const painting = document.getElementById('janela');
...
function verificarProximidadeDoQuadro() { // Referência à janela
...
// Inicializa as posições e exibições
updatePlayerPosition();
updateBackgroundPosition();
checkInteractionDisplay();

// Recalcular em redimensionamento de tela
