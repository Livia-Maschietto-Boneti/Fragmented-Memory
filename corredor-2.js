...
const portas = [
    ...
    { nome: "Corredor 3", min: 800, max: 1050 }
];
            ...
            if (portaAtual) {
                ...
                switch (portaAtual.nome) {
                    ...
                    case 'Quarto 2':
                        ...
                        localStorage.setItem('playerX', playerX);
                        setTimeout(() => {
                            window.location.href = 'p-2-1.html';
                        }, 1000);
                        break;
                    case 'Quarto 3':
                        doorSound.play();
                        localStorage.setItem('playerX', playerX);
                        setTimeout(() => {
                            window.location.href = 'p-2-2.html';
                        }, 1000);
                        break;
                    case 'Quarto 4':
                        doorSound.play();
                        localStorage.setItem('playerX', playerX);
                        setTimeout(() => {
                            window.location.href = 'p-2-3.html';
                        }, 1000);
                        break;
                    case 'Quarto 5':
                        doorSound.play();
                        localStorage.setItem('playerX', playerX);
                        setTimeout(() => {
                            window.location.href = 'p-2-4.html';
                        }, 1000);
                        break;
                    case 'Corredor 3':
                        if (Inventario.has('cerebro2')) {
                            localStorage.setItem('parte1FoiMostrada', 'false');
                            window.location.href = 'corredor-3.html';
                        } else {
                            alert('Você precisa terminar o desafio da Livx.');
                        }
                        break;
                }
            }
