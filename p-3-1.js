...
const painting = document.getElementById('cidao');
...
function updateBackgroundPosition() {
    ...
    const manequimScreenX = paintingWorldX - backgroundPixelOffset;
    painting.style.left = `${manequimScreenX}px`; // Usa 'left' para posicionamento
}
